...
9 if buying each product points for eg 5rs=2 zomato point and each product has different purchasing points
for eg for 5rs=1 zomato point for p2 10rs=5 zomato point and p3 5rs=1 zomato point
calculate the points collect by each customers and for which product most points have been given till now.
